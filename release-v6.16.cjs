/**
 * release-v6.16.cjs — Upload APK 345 / 6.16 para Vercel Blob + Firestore
 * Motivo: ajuste final ícone Android 55%, validado em device real MIUI.
 */
...
(async () => {
  ...
  console.log('\nDONE — release v6.16 / 345 publicada');
  process.exit(0);
